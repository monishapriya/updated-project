...
<body>
	 <h3 style="font-family:monotype corsiva;color:black;font-size: 1.5em;"><b>OrderDetails</b></h3>
<div  ng-app="addToCartApp"  ng-controller = "addToCartCtrl"  ng-init="retrieveCart('${cartId}')">
 ...
 cartApp.controller("addToCartCtrl", function ($scope, $http){
     ...
     $scope.removeItemFromCart = function (name) {
         $http.put('http://localhost:8080/beautycare/categoryDropdown/productDisplay/usercart/cart/removeItem/'+name).success(function (data) {
     ...
     $scope.addItemToCart = function (id) {
         $http['delete']('http://localhost:8080/beautycare/usercart/cart/addItem/'+id).success(function (data) {
