...
.background {
	background-image: url("http://wallpapers4screen.com/Uploads/29-1-2016/23107/thumb2-petals-beads-mirror-bubble-lipstick.jpg");
	background-size:100%;
}
...
<%@ include file="header.jsp" %>
  <h3>Please Enter the Correct Username or password!</h3>
