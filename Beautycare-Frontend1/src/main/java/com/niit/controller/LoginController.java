...
import com.niit.dataaccessobject.CategoryDAO;
import com.niit.dataaccessobject.ProductDAO;
import com.niit.dataaccessobject.SupplierDAO;
import com.niit.dataaccessobject.UserDAO;
...
String username = SecurityContextHolder.getContext().getAuthentication().getName();
		...
		{
		 System.out.println(authority.getAuthority()+"   user");
